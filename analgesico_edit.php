  ...
  if ($msg_sucesso){
   ...
   ?>
	...
	//CONECTA AO MYSQL              
		...
		$mysql = new Mysql();
		$mysql->conectar(); 
		$sql = mysql_query("SELECT * FROM analgesicos WHERE id_analgesico = ".$id_analgesico."");
    ...
    <tr> 
      <td colspan="2" class="labelEsquerda"><input type="hidden" name="id_analgesico" value="<?php echo $id_analgesico;?>">
        <input type="hidden" name="opcao" value="<?php echo $opcao;?>"></td>
    </tr>
    <tr> 
      <td colspan="6" class="labelCentro"><input name="editarAnalgesico" type="submit" value="Editar" /> 
