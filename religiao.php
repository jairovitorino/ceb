...
function caixas(){
	...
	document.formulario.nm_religiao.focus();
}
...
<form name="formulario" id="formulario" method="post" action="aluno_controller.php" enctype="multipart/form-data" >
  ...
  if ($msg_sucesso){
   ...
   ?>
    ...
    <tr> 
      <td colspan="6" class="labelCentro"><input name="inserirReligiao" type="submit" value="Gravar" /> 
...
<table width="29%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <?php
 	 require_once("class/conexao.php");
		$mysql = new Mysql();
		$mysql->conectar(); 
	 $sql = mysql_query("SELECT * FROM religioes ORDER BY nm_religiao ");
  ...
  <tr onMouseOver="move_i(this)" onMouseOut="move_o(this)" title=""> 
     <td class="labelEsquerda"><?php echo $nm_religiao;?></td>
     <td class="labelCentro"><a href="aluno_controller.php?abrirReligiaoEdit=abrirReligiaoEdit&id_religiao=<?php echo $id_religiao;?>&opcao=1"><img src="img/insert.gif" width="10" height="10"></a></td>
    <td class="labelCentro"><a href="javascript:del('aluno_controller.php?excluirReligiao=excluirReligiao&id_religiao=<?php echo $id_religiao;?>&opcao=1')"><img src="img/excluir2.gif" width="10" height="10"></a></td>
  </tr>
  <?php }?>
  <tr> 
