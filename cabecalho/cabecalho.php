...
$titulo == "" ? $titulo = "Escola" : $titulo = $titulo;
$icon = @$_SESSION['icon'];
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr bgcolor="#333333">  
      <td colspan="5"><div align="center"><font color="#000099" size="2" face="Arial, Helvetica, sans-serif">&nbsp;<font color="#FFFFFF"><?php echo $_SESSION['nm_ente'];?></font></font></div></td>
  </tr>
   <tr bgcolor="#ffffff"> 
    ...
    <td width="18%" bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="labelCentro"><font color="#FF0000" size="2" face="Courier New, Courier, mono">&nbsp; 
      ...
      <td><ul class="udm" id="udm" name="udm"> <li><a href="#">Cadastros</a> 
          <ul>
			...
			<li><a href="pesquisa_controller.php?abrirPesquisaObjeto=abrirPesquisaObjeto&opcao=matricula">Matricula</a> </li>
			  <?php } else {?>
	     ...
	     <ul>
          ...
          <li><a href="#">Matr&iacute;culas</a> 
            <ul>
			  ...
			  <li><a href="matricula_controller.php?abrirMatriculaListaDif=abrirMatriculaListaDif">Outros</a></li>
			  </ul>
          </li>
		   <li><a href="financeiro_controller.php?abrirFinanceiroLista=abrirFinanceiroLista">Financeiro</a> </li>
          ...
          <li><a href="#">Respons&aacute;veis</a> 
            <ul>
              ...
              <li><a href="pesquisa_controller.php?abrirPesquisaData=abrirPesquisaData&opcao=resp">Data</a></li>
            </ul>
          </li>
        </ul>
          ...
          <ul> 
			...
			<li><a href="usuario_controller.php?abrirUsuarioLista=abrirUsuarioLista">Usu&aacute;rios</a></li>
				...
				<li><a href="#">Dados</a>
                  ...
                  <li><a href="#">Religi&otilde;es</a> 
                    <ul>
					 	<li><a href="aluno_controller.php?abrirReligiao=abrirReligiao">Inserir/Listar</a></li>
					 </ul>
				    </li>				         
...
<?php } else {?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr bgcolor="#333333"> 
    <td colspan="5"><div align="center"><font color="#000099" size="2" face="Arial, Helvetica, sans-serif"><font color="#FFFFFF">ESCOLA</font></font></div></td>
  </tr>
     <tr bgcolor="#ffffff"> 
    <td colspan="5"><div align="center"><font color="#000099" size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;<font color="#FFFFFF">ADMINISTRA&Ccedil;&Atilde;O</font></font></div></td>
  </tr>
