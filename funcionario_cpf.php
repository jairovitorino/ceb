...
<form name="formulario" id="formulario" method="post" action="funcionario_controller.php" >
  ...
  if ($msg_sucesso){
   ...
   ?>
    ...
    <tr> 
      <td colspan="7" class="labelEsquerda"><strong>Funcion&aacute;rio</strong></td>
    </tr>
    <tr> 
      <td colspan="7" class="labelEsquerda">&nbsp;</td>
    </tr>
    ...
    <tr> 
	  ...
	  <tr> 
      <td colspan="7" class="labelCentro"><input name="pesquisarFuncionarioCpf" type="submit" value="Pesquisar" /> 
